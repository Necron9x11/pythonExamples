...
# This version takes all we have seen so far and ties it all together into one program that calculates squares and outputs the answer in either a terse or a verbose manner. In addition it adds removes "count=[0, ..., n]" and adds the 'action="count"' parameters to the .add_argument method. 
